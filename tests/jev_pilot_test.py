...
class PilotTest(unittest.TestCase):
 def package(self, directory):
  ...
  expected={"recordId":"r1","inputHash":row["inputHash"],"rubricHash":rh,"reviewStatus":"unreviewed","expectedAnswers":{"evidenceSufficient":"pass","trackingBehaviorPreserved":"fail"}}
