...
`scripts/jev_freeze.py` converts the reviewed seed rubric into two saved native `AIFunction` runs. It creates definitions only; it does not evaluate an observation, invoke GEPA, create calibration labels, or mark either function accepted.
