...
## BLADE visitor journeys (separate training corpus)

See [BLADE synthetic guide](../../DOCUMENTATION/blade-synthetic/README.md) for the public-site-informed generator, paired drift cases, source provenance, report assumptions and observation-only download. This corpus is separate from the frozen pilot and reserved splits. It is not yet connected to the daily behavioral evaluator.
